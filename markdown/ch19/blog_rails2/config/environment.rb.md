...
Rails::Initializer.run do |config|
  ...
  # By default, all plugins in vendor/plugins
  ...
  # Make Time.zone default to the specified zone, and
  # make Active Record store time values in the database in UTC,
  # and return them converted to the specified local zone.
  ...
  # Please note that observers generated using script/generate observer need
  # to have an _observer suffix
