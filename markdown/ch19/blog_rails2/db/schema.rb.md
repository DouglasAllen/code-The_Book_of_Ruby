...
# your database schema. If you need to create the application database on
# another system, you should be using db:schema:load, not running
...
ActiveRecord::Schema.define(version: 20_081_231_131_720) do
