...
# calls a public method (shout) with ob of descendent
# class which calls a private method (priv) - that's NOT OK!
# myob.shout( myotherob )

# calls a public method (shout) with ob of ancestor
# class which calls a private method (priv) - that's NOT OK!
myotherob.shout(myob)

# calls public method (exclaim) which calls a protected
# method (prot) with a descendent class - that's OK
